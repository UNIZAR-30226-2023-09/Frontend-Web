            ...
            <div className="col-7">
                <div className="popupProp">
                    ...
                    <div className="buttonContainer">
                        <button className="confirmarP" onClick={edificarPropiedad}>EDIFICAR</button>
